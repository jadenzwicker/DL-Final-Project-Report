...
Brieuc Popper & SmolLM finetuning, general coding tasks & Designed and ran the fine-tuning experiments with SmolLM-135M. Helped team setup on PACE ICE GPUs and all around Python Code with \textit{transformers} library to deal with LLMs \\
